...
exakten Ausgabe wüchse das erforderliche Antriebsmoment mit den Lagen der
Seiltrommel. Und die Geschwindigkeit der Seilposition wüchse bei jeder neuen
Seillage sprunghaft. In der Betriebsart \"Druchmesserkommulation\"
...
\"Druchmesserkommulation\", ein konstanter Trommeldurchmesser
...
//Kraft an oberer Flasche
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body>Der Flaschenzug bietet analog zum Getriebe im Rotatorischen eine Untersetzung im Translatorischen.&nbsp;<div><br></div><div><b>Ports</b></div><div>Das Modell besitzt drei F_s Prots, über diese Ports können bidirektional die Kraft und die Position übergeben werden.&nbsp;<br>
...
//Einfluss der Massenträgheit der unteren Flasche aud die Gesamtkraft
        Fges = f_s.F - Flaschengewicht_unten * g - Flaschengewicht_unten * der(v) - Flaschengewicht_oben * v_oben;
//an der unteren Flasche wirkende Kraft
        f_s2.F = Fges / (n + 1);
//Gesch. der oberen Flasche
        v_oben = der(f_s1.s);
...
//Berechnung der Geschwindigkeits-Variable
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body>Die<b> Masse </b>dient im Modell meist als Objekt, das bewegt werden soll. In der Simulation wird die Trägheit mit berücksichtigt.&nbsp;<div><b>Parametrierba</b>r ist hierbei allein die Masse in Kilogramm.&nbsp;</div><div><br></div><div>Am <b>Kraft-Weg-Port</b> können Kräfte und Positionen bideirektional übergeben werden.</div></body></html>"));
      end Masse;
...
//Berechnung der Geschwindigkeits-Variable
        ...
        annotation(
          ...
          Documentation(info = "<html><head></head><body><span style=\"font-size: 12px;\">Die</span><b style=\"font-size: 12px;\">&nbsp;Masse&nbsp;</b><span style=\"font-size: 12px;\">dient im Modell meist als Objekt, das bewegt werden soll. In der Simulation wird die Trägheit mit berücksichtigt.&nbsp;</span><div style=\"font-size: 12px;\"><b>Parametrierba</b>r ist hierbei allein die Masse in Kilogramm.&nbsp;</div><div style=\"font-size: 12px;\"><br></div><div style=\"font-size: 12px;\">Am&nbsp;<b>Kraft-Weg-Port</b>&nbsp;können Kräfte und Positionen bideirektional übergeben werden.</div></body></html>"));
      end Bierkasten;
    annotation(
        Icon(graphics = {Polygon(fillColor = {102, 102, 102}, fillPattern = FillPattern.Solid, points = {{-100, 60}, {-60, 100}, {60, 100}, {100, 60}, {100, -100}, {-100, -100}, {-100, -84}, {-100, 60}}), Text(origin = {-35, 33}, lineColor = {221, 221, 221}, fillColor = {235, 235, 235}, fillPattern = FillPattern.Solid, extent = {{-27, 23}, {97, -77}}, textString = "Masse")}, coordinateSystem(initialScale = 0.1)),
...
//konstantes Moment an Port weitergeben
  ...
  connect(bierkasten1.f_s, flaschenzug_Modell_b.f_s) annotation(
      ...
      annotation(
          ...
          Icon(graphics = {Polygon(origin = {30, 80}, lineColor = {63, 188, 44}, fillColor = {88, 195, 64}, fillPattern = FillPattern.Solid, points = {{70, -82}, {-30, 20}, {-30, -20}, {-30, -178}, {70, -82}}), Rectangle(origin = {-70, 41}, lineColor = {53, 202, 46}, fillColor = {55, 173, 65}, fillPattern = FillPattern.Solid, extent = {{-30, 9}, {70, -89}})}, coordinateSystem(initialScale = 0.1)),
  Documentation(info = "<html><head></head><body>Dieses Modell ist zum Testen des Flaschenzugs entwirfen worden. Die 40kg schwere Masse zieht den 100kg schweren Bierkasten in der Simulation nach oben. Der Föaschenzug hat ene übersetzung von 3.&nbsp;<div>Eine boolesche Senke ist nicht notwendig.</div><div><br></div><div><span style=\"font-size: 12px;\">Die einzelnen Modelle sind alle parametrierbar&nbsp;</span><b style=\"font-size: 12px;\">(Infos: siehe Modell-Readme in der Bibliothek)</b><span style=\"font-size: 12px;\">.</span></div></body></html>"));
